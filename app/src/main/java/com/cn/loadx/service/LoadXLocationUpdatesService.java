 ...
 */
public class LoadXLocationUpdatesService extends Service {

    private static final String PACKAGE_NAME =
            "com.google.android.gms.location.sample.locationupdatesforegroundservice";

    private static final String TAG = LoadXLocationUpdatesService.class.getSimpleName();
    ...
    public LoadXLocationUpdatesService() {
    }
        ...
        if (!mChangingConfiguration && Utils.requestingLocationUpdates(this)) {
            ...
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.O) {
                mNotificationManager.startServiceInForeground(new Intent(this,
                        LoadXLocationUpdatesService.class), NOTIFICATION_ID, getNotification());
            } else {
    ...
    public void requestLocationUpdates() {
        ...
        startService(new Intent(getApplicationContext(), LoadXLocationUpdatesService.class));
        try {
    ...
    private Notification getNotification() {
        String tripStatus =  SharedPrefsUtils.getStringPreference(LoadXLocationUpdatesService.this, KEY_TRIP_STATUS);
        String notificationTittle="";
        String destAddress = SharedPrefsUtils.getStringPreference(LoadXLocationUpdatesService.this,KEY_DEST_ADDRESS);
        if(tripStatus!=null)
        {
            if(tripStatus.equals(TR_SCHEDULED))
                notificationTittle = "Trip assigned to "+destAddress;
            else if(tripStatus.equals(TR_ONGOING))
       ...
       // CharSequence text = Utils.getLocationText(mLocation);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                /*.addAction(R.drawable.x_logo, getString(R.string.launch_activity),
                        activityPendingIntent)
                .addAction(R.drawable.ic_cancel, getString(R.string.remove_location_updates),
                        servicePendingIntent)*/
                .addAction(android.R.drawable.ic_menu_compass,getString(R.string.view_details),
                        activityPendingIntent)
                .setContentText(notificationTittle)
    ...
    private void updateLocationToServer(Location location) {
        ...
        setLocationUpdate.enqueue(new Callback<TripStatus>() {
            ...
            public void onResponse(Call<TripStatus> call, Response<TripStatus> response) {
                ...
                if(tripStatus!=null) {
                    if (tripStatus.getError()) {
                        Log.d("LXS", "Location updated failed");
                    } else {
                        Log.d("LXS", "Location updated success");
                    }
                }
            }
            ...
            public void onFailure(Call<TripStatus> call, Throwable t) {
                Log.d("LXS","Location updated failed"+t.getMessage());
            }
        });
    }
    ...
    public class LocalBinder extends Binder {
        public LoadXLocationUpdatesService getService() {
            return LoadXLocationUpdatesService.this;
        }
    }
