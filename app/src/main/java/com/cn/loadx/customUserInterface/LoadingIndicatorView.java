package com.cn.loadx.customUserInterface;
...
public class LoadingIndicatorView extends View {
    ...
    private static final String TAG="ARLoadingView";
    ...
    private static final String APP_INDICATOR_NAME="com.cn.loadx.customUserInterface.LineScaleIndicator";
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, ContextCompat.getColor(context, R.color.app_color));
        setIndicator(APP_INDICATOR_NAME);
        if (mIndicator==null){
